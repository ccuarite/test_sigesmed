...
public class InsertarTipoOrganizacionTx implements ITransaction{
    ...
    public WebResponse execute(WebRequest wr) {
        ...
        */
        TipoOrganizacion nuevoModulo = null;
        try{
            ...
            nuevoModulo = new TipoOrganizacion((short)0, codigo, nombre, descripcion, new Date(), 1, estado.charAt(0), null);
        ...
        */
        ...
        oResponse.addElement("tipoOrganizacionID",nuevoModulo.getTipOrgId());
