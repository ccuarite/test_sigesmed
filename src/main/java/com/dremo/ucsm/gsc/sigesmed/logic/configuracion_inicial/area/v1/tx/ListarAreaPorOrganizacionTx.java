 ...
 */
public class ListarAreaPorOrganizacionTx implements ITransaction{
    ...
    public WebResponse execute(WebRequest wr) {
        ...
        try{
            ...
            organizacionID = requestData.getElementInteger("organizacionID");
        ...
        */
        ...
        try{
            //listar las Areaes
            String hql = "SELECT a FROM Area a JOIN FETCH a.organizacion LEFT JOIN FETCH a.areaPadre WHERE a.estReg!='E' and a.organizacion.orgId='"+ organizacionID +"'" ;
        ...
        */
        ...
        for(Area area:areas ){
            ...
            if(area.getAreaPadre()!=null){
                ...
                oResponse.addElement("areaPadre",area.getAreaPadre().getNom() );
            }
