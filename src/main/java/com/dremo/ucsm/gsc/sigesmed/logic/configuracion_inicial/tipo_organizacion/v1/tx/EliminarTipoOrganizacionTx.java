    ...
    public WebResponse execute(WebRequest wr) {
        ...
        */
        ...
        try{
            ...
            tipoOrganizacionID = requestData.getElementInteger("tipoOrganizacionID");
        ...
        */
        ...
        try{
            //eliminando tipoOrganizacion
            String hql = "UPDATE TipoOrganizacion to SET to.estReg='E' WHERE to.tipOrgId ="+tipoOrganizacionID;
